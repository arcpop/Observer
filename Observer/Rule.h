...
#define PROCESS_CREATION_CHECK_PARENT_NAME_EQUALS (1 << 3)
#define PROCESS_CREATION_CHECK_PARENT_NAME_CONTAINS (1 << 4)
#define PROCESS_CREATION_CHECK_PARENT_NAME_ENDS_WITH (1 << 5)
...
typedef struct _OBSERVER_REGISTRY_RULE
{
	...
	WCHAR ValueNameBuffer[REGISTRY_RULE_VALUE_NAME_BUFFER_LENTGTH];
	WCHAR Path[1];
