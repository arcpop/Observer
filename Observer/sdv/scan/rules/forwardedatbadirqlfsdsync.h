...
#if ((startioroutine_SDV_RESULT == SDV_FAILED || dispatchroutine_SDV_RESULT == SDV_FAILED || cancelroutine_SDV_RESULT == SDV_FAILED) && iobuildsynchronousfsdrequest_SDV_RESULT == SDV_FAILED )
